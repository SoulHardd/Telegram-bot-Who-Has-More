...
async def rules(callback: types.CallbackQuery):
    await callback.message.answer(text='<strong>Правила игры "У кого больше?:"</strong>'
                            ...
                            '\n\nПри правильном ответе начисляется 1 балл,'
                            ' а затем выводится новый фильм, '
                            'который вы должны сравнить с предыдущим. '
                            '\nПри Неправильном ответе игра заканчивается, и баллы обнуляются.'
